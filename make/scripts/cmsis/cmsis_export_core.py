...
def parseCmsisData(fileName):
    ...
    """
    ProjectData = namedtuple("ProjectData", "projectName deviceName core linkerScript defineList includePathList cSrcList asmSrcList headersList libsList searches getlibsSharedDir")
    ...
    return ProjectData(projectName, device, core, linkerScript, defineList, includePathList, cSrcList, asmSrcList, headersList, libsList, searches, getlibsSharedDir)
...
def generatePdsc(inFile, cpdscFile, gpdscFile, cprjFile, architectureElement):
    """
...
def run_export(architectureElement):
    ...
    generatePdsc(args.inFile, args.cpdscFile, args.gpdscFile, args.cprjFile, architectureElement)
